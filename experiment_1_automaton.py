# automaton class for experiment 1

# use polar coordinates, the angles are in radian

# as a temporary fix of this bipolar sensing sector design in the automaton
# linear acceleration is disabled so automaton doesn't running crazy
...
class Automaton:
    ...
    def update_with_accel(self, delta_t):  # update with calculated acceleration
        ...
        vel_new = self.vel  # debug, reset new velocity, so no vel change
